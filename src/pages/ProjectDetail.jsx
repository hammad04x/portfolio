...
export default function ProjectDetail() {
  ...
  const pageTitle = `${project.title} — Hammad Jagarala`
  ...
  return (
    ...
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://jagaralahammad.vercel.app/projects/${slug}`} />

        <meta property="og:title" content={pageTitle} />
        <meta property="og:description" content={pageDesc} />
        <meta property="og:image" content={`https://jagaralahammad.vercel.app${project.images?.[0] || "/preview.jpg"}`} />
        <meta property="og:url" content={`https://jagaralahammad.vercel.app/projects/${slug}`} />
